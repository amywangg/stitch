...
version: 1.3.0
description: "21 production-ready scripts for iOS simulator automation. Use when: (1) asked to build, run, or launch the iOS app in the simulator, (2) asked to verify a screen renders correctly or tap through a flow, (3) running accessibility audits on an iOS screen, (4) capturing screenshots or debug snapshots, (5) managing simulator lifecycle (boot, shutdown, erase). Do NOT auto-invoke during normal code writing -- only when explicitly testing or verifying in the simulator."
---
